...
if(isset($_POST['submit'])){
	...
	if($fields_validated){
		...
		$db->addKlant($voorletters, $db::KLANT, $achternaam, $gebruikersnaam, $wachtwoord);
	}
}
?>
<html>	
	<head>
		...
		<div>
			<form action="signupKlant.php" method="post">
		...
		<a href="loginKlant.php"> Terug naar inloggen</a><br>
</html>